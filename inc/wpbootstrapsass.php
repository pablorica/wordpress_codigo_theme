...
/*------------------------------------*\
    Theme Support (defined in custom_setup.php)
\*------------------------------------*/
...
/**
------------- Menu Navigation (defined in class-wp-codigo-navwalker.php)
...
/**
------------- Enqueue Scripts (copied to custom_enqueue.php)
...
/**
------------- (copied to custom_pagination.php)
...
/**
------------- (copied to custom_functions.php)
...
// Add Actions
//add_action('init', 'wpbootstrapsass_header_scripts'); // Add Custom Scripts to wp_head (copied to custom_enqueue.php)
//add_action('wp_print_scripts', 'wpbootstrapsass_conditional_scripts'); // Add Conditional Page Scripts (copied to custom_enqueue.php)
//add_action('get_header', 'enable_threaded_comments'); // Enable Threaded Comments (Not needed)
//add_action('wp_enqueue_scripts', 'wpbootstrapsass_styles'); // Add Theme Stylesheet (copied to custom_enqueue.php)
//add_action('init', 'register_wpbootstrapsass_menu'); // Add WP Bootstrap Sass Menu  (copied to custom_setup.php)
//add_action('init', 'create_post_type_custom_post_type_demo'); // Add our WP Bootstrap Sass Custom Post Type (copied to custom_types.php)
//add_action('widgets_init', 'my_remove_recent_comments_style'); // Remove inline Recent Comment Styles from wp_head() (Not needed)
//add_action('init', 'wpbootstrapsass_pagination'); // Add our wpbootstrapsass Pagination (copied to custom_pagination.php)
...
// Add Filters
//add_filter('script_loader_tag', 'add_script_tag_attributes', 10, 2); // Add attributes to CDN script tag (copied to custom_enqueue.php)
//add_filter('avatar_defaults', 'wpbootstrapsassgravatar'); // Custom Gravatar in Settings > Discussion (Not needed)
//add_filter('body_class', 'add_slug_to_body_class'); // Add slug to body class (Starkers build) (copied to custom_functions.php)
//add_filter('widget_text', 'do_shortcode'); // Allow shortcodes in Dynamic Sidebar  (copied to custom_shortcodes.php)
//add_filter('widget_text', 'shortcode_unautop'); // Remove <p> tags in Dynamic Sidebars (better!)  (copied to custom_shortcodes.php)
//add_filter('wp_nav_menu_args', 'my_wp_nav_menu_args'); // Remove surrounding <div> from WP Navigation (Not needed)
// add_filter('nav_menu_css_class', 'my_css_attributes_filter', 100, 1); // Remove Navigation <li> injected classes (Commented out by default)
// add_filter('nav_menu_item_id', 'my_css_attributes_filter', 100, 1); // Remove Navigation <li> injected ID (Commented out by default)
// add_filter('page_css_class', 'my_css_attributes_filter', 100, 1); // Remove Navigation <li> Page ID's (Commented out by default)
//add_filter('the_category', 'remove_category_rel_from_category_list'); // Remove invalid rel attribute (Not needed)
//add_filter('the_excerpt', 'shortcode_unautop'); // Remove auto <p> tags in Excerpt (Manual Excerpts only) (copied to custom_shortcodes.php)
//add_filter('the_excerpt', 'do_shortcode'); // Allows Shortcodes to be executed in Excerpt (Manual Excerpts only) (copied to custom_shortcodes.php)
//add_filter('excerpt_more', 'wpbootstrapsass_view_article'); // Add 'View Article' button instead of [...] for Excerpts (copied to custom_setup.php)
//add_filter('show_admin_bar', 'remove_admin_bar'); // Remove Admin bar (copied to custom_setup.php)
//add_filter('style_loader_tag', 'wpbootstrapsass_style_remove'); // Remove 'text/css' from enqueued stylesheet (copied to custom_enqueue.php)
//add_filter('post_thumbnail_html', 'remove_thumbnail_dimensions', 10); // Remove width and height dynamic attributes to thumbnails (copied to custom_setup.php)
//add_filter('image_send_to_editor', 'remove_thumbnail_dimensions', 10); // Remove width and height dynamic attributes to post images (copied to custom_setup.php)
// add .img-fluid class to images in the content
//add_filter('the_content', 'add_class_to_image_in_content'); (copied to custom_setup.php)

// Remove Filters
//remove_filter('the_excerpt', 'wpautop'); // Remove <p> tags from Excerpt altogether  (copied to custom_setup.php)

/**
------------- (copied to custom_shortcodes.php)
// Shortcodes 
...
/*------------------------------------*\
    Custom Post Types  (copied to custom_types.php)
\*------------------------------------*/
/**
...
/*------------------------------------*\
    ShortCode Functions  (copied to custom_shortcodes.php)
\*------------------------------------*/
/*
