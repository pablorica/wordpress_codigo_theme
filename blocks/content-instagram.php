...
$style 					= get_field('binstagram_style');
$style['section_style'] = "";
$style['section_data']  = "";

$block_menucolor = (get_field('binstagram_menu_color')?get_field('binstagram_menu_color'):'bg-green');


$htmlBack   = '';
$htmlStyle  = '';
$background = get_field('binstagram_background'); 
...
$htmlBody   = '';
$block_body = get_field('binstagram_content');
$block_body['groupname'] = 'binstagram_content';
...
$htmlBody .= '
<div class="row gblock__instagram_body--text my-auto '.$animation_css.'">
	<div id="'.$style['content_id'].'" class="gblock__instagram_body--content d-flex flex-column '.$style['content_class'].' " '.($block_body['colour'] ? 'style="color:'.$block_body['colour'].'"' : '').' >';

	if($block_body['headline']) {
		$htmlBody .= '<div class="gblock__instagram_body--headline py-5">'.$block_body['headline'].'</div>';
	}

	$htmlBody .= '
		<div class="gblock__instagram_body--shortcode my-auto py-5">
            '.$block_body['shortcode'].'
        </div>';
...
'.$htmlBack.'
  <div id="'.$style['block_id'].'" class="gblock__instagram container-md '.$style['block_class'].' d-flex flex-column">
	'.$htmlBody.'
  </div>
</section>'
.$htmlStyle;